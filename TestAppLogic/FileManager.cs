namespace TestAppLogic
{
    ...
    {
        private static ConfigParameters parameters = ConfigReader.ReadConfigData();
        ...
        {
            var pathToFile = Path.Combine(parameters.OutputFolder, fileName + ".REPORT.txt");
            ...
            writer.WriteLine("--------------------------------");
            writer.WriteLine("Processing time: {0} miliseconds", elapsedTime.ToString());
            writer.Close();
        }
